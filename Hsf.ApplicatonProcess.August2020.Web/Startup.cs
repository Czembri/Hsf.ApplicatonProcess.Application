...
namespace Hsf.ApplicatonProcess.August2020.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var section = Configuration.GetSection(nameof(MessagesConfig));
            var messagesConfig = section.Get<MessagesConfig>();
            services.AddSingleton(messagesConfig);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("v1/swagger.json", "Applicants");
                });
            }
